...
export default function Alerts() {
  ...
  const badgeForType = (type) => {
    ...
    if (t.includes('HEART') || t.includes('SPO2') || t.includes('HYPOXIA') || t.includes('TACKYCARDIA') || t.includes('CRITICAL')) return 'badge-red';
    if (t.includes('TEMP') || t.includes('HYPERTHERMIA')) return 'badge-amber';
    return 'badge-blue';
  };
