...
export const getAIDiagnostics      = (patientId)      => API.get(`/ai/diagnostics/${patientId}`);
export const getAllAIDiagnostics    = ()               => API.get('/ai/diagnostics');
export const uploadMultimodalData  = (patientId, data) => API.post(`/ai/upload/${patientId}`, data);
export const getEmbeddingSpace     = ()               => API.get('/ai/embedding-space');
export const getClinicalData       = (patientId)      => API.get(`/ai/clinical-data/${patientId}`);
